...
XmlElement.prototype.removeChildNamed = function(name) {
    var i;
...
XmlElement.prototype.removeChildren = function() {
    this.children = [];
}

XmlElement.prototype.addChild = function(name, attributes) {
    var child = new XmlElement({name: name, attributes: attributes});
    this.children.push(child);
    return child;
}
